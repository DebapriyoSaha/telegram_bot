...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    GoogleSheetsModule.log_chat_history(
        ...
        username, name, user_text, reply, input_tokens, output_tokens
    )
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    GoogleSheetsModule.log_meal_tracker(
        sheets_service, GOOGLE_SHEET_ID,
        username, name, entry.food, entry.calories, entry.proteins, entry.carbs, entry.fat, entry.image_url, entry.time_elapsed, input_tokens, output_tokens
    )
...
async def handle_feedback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if context.user_data.get('awaiting_feedback'):
        ...
        GoogleSheetsModule.log_feedback(sheets_service, GOOGLE_SHEET_ID, username, name, feedback_text)
